...
{if !$isFirstVisit}
	{capture assign='contentHeaderNavigation'}
		<li id="backToReferrer" style="display: none"><a href="#" class="button" rel="noopener">{icon size=16 name='arrow-left'} {lang}wcf.page.error.backward{/lang}</a></li>
	{/capture}
...
{if !$__wcf->user->userID}
	<section class="section">
		...
		<p style="margin-top: 20px"><a href="{link controller='Login' url=$__wcf->getRequestURI()}{/link}" class="button">{icon size=16 name='key'} {lang}wcf.user.loginOrRegister{/lang}</a></p>
	</section>
{/if}
