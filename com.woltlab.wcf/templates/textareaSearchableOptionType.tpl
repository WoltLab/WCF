...
<textarea id="{$option->optionName}" name="values[{$option->optionName}]"{if !$searchOption} disabled="disabled"{/if} {if $option->required}required="required"{/if} cols="40" rows="10">{$value}</textarea>
