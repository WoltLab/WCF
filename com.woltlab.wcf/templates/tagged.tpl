...
{capture assign='contentInteractionButtons'}
	<a href="{link controller='TagSearch'}{/link}" class="contentInteractionButton button small">{icon size=16 name='magnifying-glass'} <span>{lang}wcf.search.type.tags{/lang}</span></a>
{/capture}
