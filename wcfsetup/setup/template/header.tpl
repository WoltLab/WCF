		...
		<div>
			<div id="logo" class="logo">
				<a>
					...
					<img src="{if $lastStep|isset}{@RELATIVE_WCF_DIR}acp/images/{else}install.php?tmpFilePrefix={@TMP_FILE_PREFIX}&amp;showImage={/if}wcfLogo2.png" width="300" height="58" alt="" />
				</a>
			</div>
