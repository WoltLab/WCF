...
(function (window, undefined) { $.Redactor.prototype.WoltLabObserve=function(){"use strict";return{init:function(){var t=elByClass("re-button",this.button.toolbar()[0]);this.button.setInactiveAll=function(e){for(var o,s=0,i=t.length;s<i;s++)o=t[s],o.classList.contains("re-"+e)||o.classList.remove("redactor-act")}.bind(this),this.observe.buttons=function(t,e){var o=this.selection.current();if(!1!==t?this.button.setInactiveAll():this.button.setInactiveAll(e),!1===t&&"html"!==e)return void(-1!==$.inArray(e,this.opts.activeButtons)&&this.button.toggleActive(e));if(this.utils.isRedactorParent(o)){var s=this.WoltLabSource.isActive();this.utils.isCurrentOrParentHeader()||this.utils.isCurrentOrParent(["table","pre","blockquote","li"])?this.button.disable("horizontalrule"):s||this.button.enable("horizontalrule"),this.utils.isCurrentOrParent(["table","li"])?(this.button.disable("code"),this.button.disable("spoiler"),this.button.disable("woltlabQuote")):s||(this.button.enable("code"),this.button.enable("spoiler"),this.button.enable("woltlabQuote"));var i=this.$editor[0];o.nodeType!==Node.ELEMENT_NODE&&(o=o.parentNode);for(var n,r=[];o!==i;)n=o.nodeName.toLowerCase(),-1===r.indexOf(n)&&(this.opts.activeButtonsStates.hasOwnProperty(n)&&this.button.setActive(this.opts.activeButtonsStates[n]),r.push(n)),o=o.parentNode}}.bind(this),this.observe.dropdowns=function(){var t,e=this.selection.current(),o=this.$editor[0],s=this.utils.isRedactorParent(e),i=[];if(e&&s)for(e.nodeType!==Node.ELEMENT_NODE&&(e=e.parentNode);e!==o;)t=e.nodeName.toLowerCase(),-1===i.indexOf(t)&&i.push(t),e=e.parentNode;for(var n,r=null,a=0,l=this.opts.observe.dropdowns.length;a<l;a++){n=this.opts.observe.dropdowns[a];var u=n.observe,h=u.element,b=n.item,d=!!u.in&&u.in,c=!!u.out&&u.out;"a"===h&&null===r&&(r=$("<div />").html(this.selection.html()).find("a").length),-1!==i.indexOf(h)&&s||"a"===h&&0!==r?this.observe.setDropdownProperties(b,d,c):this.observe.setDropdownProperties(b,c,d)}}.bind(this)}}}; })(this);
...
(function (window, undefined) { $.Redactor.prototype.WoltLabTable=function(){"use strict";return{init:function(){this.WoltLabEvent.register("insertedTable",function(){window.setTimeout(function(){var t=this.selection.block()||this.selection.current();if("TBODY"===t.nodeName){var e=elBySel("td",t);e&&this.caret.end(e)}}.bind(this),10)}.bind(this))}}}; })(this);
