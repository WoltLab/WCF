...
(function (window, undefined) { $.Redactor.prototype.WoltLabLink=function(){"use strict";var t=null;return{init:function(){this.link.isUrl=function(t){var e,i,s,n,r,l;return/^https?:\/\//.test(t)?t:(e="((xn--)?[\\W\\w\\D\\d]+(-(?!-[\\W\\w\\D\\d])+)*\\.)+[\\W\\w]{2,}",i=new RegExp("^(http|ftp|https|steam|ts3server)://"+e,"i"),s=new RegExp("^"+e,"i"),n=new RegExp(".(html|php)$","i"),r=new RegExp("^/","i"),l=new RegExp("^tel:(.*?)","i"),-1===t.search(i)&&-1!==t.search(s)&&-1===t.search(n)&&"/"!==t.substring(0,1)&&(t="https://"+t),(-1!==t.search(i)||-1!==t.search(n)||-1!==t.search(r)||-1!==t.search(l))&&t)}.bind(this),this.link.show=this.WoltLabLink.show.bind(this),this.link.parse=function(t){if(this.link.isMailto(t.url))t.url="mailto:"+t.url.replace("mailto:","");else if(0!==t.url.search("#")&&this.opts.linkValidation){var e=this.link.isUrl(t.url);!1===e&&(e="https://"+t.url),t.url=e}return!this.link.isEmpty(t)&&!1!==t.url&&t}.bind(this),require(["WoltLabSuite/Core/Ui/Redactor/Link"],(function(e){t=e}))},show:function(e,i){var s,n,r;void 0!==e&&e.preventDefault&&e.preventDefault();let l=!1;this.detect.isMobile()&&!this.core.editor()[0].contains(document.activeElement)&&(this.selection.restore(),l=!0),s=this.selection.is(),this.selection.save(),this.observe.closeAllTooltip(),n=i||!1,l&&(!1===n&&(n=this.link.is()),document.activeElement.blur()),s&&this.selection.restore(),r=this.link.buildLinkFromElement(n),s&&this.selection.save(),t.showDialog({insert:!1===n,submitCallback:function(){var t=this.link.buildLinkFromModal();return!1!==t&&(this.selection.restore(),this.link.insert(t,!0,n),this.selection.save(),window.setTimeout((()=>{document.activeElement===this.core.editor()[0]&&null===this.core.editor()[0].querySelector(".redactor-selection-marker")||this.selection.restore()}),0),!0)}.bind(this)}),this.link.setModalValues(r),this.detect.isDesktop()&&$("#redactor-link-url").focus()}}}; })(this);
