...
(function (window, undefined) { $.Redactor.prototype.WoltLabList=function(){"use strict";return{init:function(){this.list.combineAfterAndBefore=function(e){var t=$(e).prev(),n=$(e).next(),i=e&&"P"===e.tagName&&("<br>"===e.innerHTML||""===e.innerHTML),r=1===t.closest("ol, ul",this.core.editor()[0]).length&&1===n.closest("ol, ul",this.core.editor()[0]).length,o=!1;if(r&&!i&&0===e.textContent.replace(/\u200b/g,"").trim().length){var l=["A","B","BR","EM","I","STRONG","U"],s=!0;elBySelAll("*",e,function(e){-1===l.indexOf(e.nodeName)&&("SPAN"===e.nodeName&&""===e.className.trim()||(s=!1))}),s&&(o=!0,i=!0)}if(i&&r){if("LI"===e.nodeName&&o)return t.append(this.marker.get()),elRemove(e),this.selection.restore(),!0;t.children("li").last().append(this.marker.get()),t.append(n.contents());var a=e.nextElementSibling;return"OL"!==a.nodeName&&"UL"!==a.nodeName||0!==a.childElementCount||elRemove(a),o&&elRemove(e),this.selection.restore(),!0}return!1}.bind(this)}}}; })(this);
