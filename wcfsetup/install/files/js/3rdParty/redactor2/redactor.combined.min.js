...
(function (window, undefined) { $.Redactor.prototype.WoltLabBlock=function(){"use strict";return{init:function(){this.block.tags=["p","blockquote","pre","h1","h2","h3","h4","h5","h6","div","figure"],this.block.format=function(t,e,o,i){if(t="quote"===t?"blockquote":t,-1!==$.inArray(t,this.block.tags))return"p"===t&&void 0===e&&(e="class"),this.placeholder.hide(),this.buffer.set(),this.utils.isCollapsed()?this.block.formatCollapsed(t,e,o,i):this.block.formatUncollapsed(t,e,o,i)}.bind(this);var t=function(t,e){return!(document.activeElement!==t||!1===e||!this.utils.isRedactorParent(e))}.bind(this),e=this.block.formatCollapsed;this.block.formatCollapsed=function(o,i,s,r){var a=this.selection.block();if(!a||"LI"!==a.nodeName&&"TD"!==a.nodeName){var l=this.core.editor()[0];t(l,a)||(this.selection.restore(),document.activeElement!==l&&l.focus()),t(l,a)||(this.focus.end(),this.selection.save());for(var h=e.call(this,o,i,s,r),n=0,c=h.length;n<c;n++)this.WoltLabBlock._paragraphize(h[n]);return this.caret.end(h),h}}.bind(this);var o=this.block.formatUncollapsed;this.block.formatUncollapsed=function(t,e,i,s){this.selection.save(),this.selection.blocks().forEach(function(t){if("OL"===t.nodeName||"UL"===t.nodeName){t.parentNode.nodeName.toLowerCase();var e=elCreate("div");t.parentNode.insertBefore(e,t),e.appendChild(t)}}),this.selection.restore();for(var r,a=o.call(this,t,e,i,s),l=null,h=0,n=a.length;h<n;h++)if(r=a[h][0],this.WoltLabBlock._paragraphize(r),0===h)l=r;else{for(;r.childNodes.length;)l.appendChild(r.childNodes[0]);elRemove(r)}return $(l)}.bind(this),this.block.removeAllAttr=function(t){t=this.block.getBlocks(t);var e=[];return $.each(t,function(t,o){for(void 0===o.attributes&&e.push(o);o.attributes.length;)o.removeAttribute(o.attributes[0].name);e.push(o)}),e}.bind(this)},register:function(t,e){-1===this.block.tags.indexOf(t)&&(this.block.tags.push(t),this.opts.paragraphizeBlocks.push(t),-1===this.opts.blockTags.indexOf(t)&&(this.opts.blockTags.push(t),this.reIsBlock=new RegExp("^("+this.opts.blockTags.join("|").toUpperCase()+")$","i")),e&&this.WoltLabKeydown.register(t))},_paragraphize:function(t){if(-1===["p","pre","h1","h2","h3","h4","h5","h6","div","figure"].indexOf(t.nodeName.toLowerCase())){for(var e=elCreate("p");t.childNodes.length;)e.appendChild(t.childNodes[0]);t.appendChild(e)}}}}; })(this);
