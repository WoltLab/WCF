...
(function (window, undefined) { $.Redactor.prototype.WoltLabLink=function(){"use strict";var t=null;return{init:function(){this.link.isUrl=function(t){var i="((xn--)?[\\W\\w\\D\\d]+(-(?!-[\\W\\w\\D\\d])+)*\\.)+[\\W\\w]{2,}",e=new RegExp("^(http|ftp|https|steam|ts3server)://"+i,"i"),s=new RegExp("^"+i,"i"),n=new RegExp(".(html|php)$","i"),l=new RegExp("^/","i"),r=new RegExp("^tel:(.*?)","i");return-1===t.search(e)&&-1!==t.search(s)&&-1===t.search(n)&&"/"!==t.substring(0,1)&&(t="https://"+t),(-1!==t.search(e)||-1!==t.search(n)||-1!==t.search(l)||-1!==t.search(r))&&t}.bind(this),this.link.show=this.WoltLabLink.show.bind(this),this.link.parse=function(t){if(this.link.isMailto(t.url))t.url="mailto:"+t.url.replace("mailto:","");else if(0!==t.url.search("#")&&this.opts.linkValidation){var i=this.link.isUrl(t.url);!1===i&&(i="https://"+t.url),t.url=i}return!this.link.isEmpty(t)&&!1!==t.url&&t}.bind(this),require(["WoltLabSuite/Core/Ui/Redactor/Link"],(function(i){t=i}))},show:function(i,e){var s,n,l;void 0!==i&&i.preventDefault&&i.preventDefault();let r=!1;this.detect.isMobile()&&!this.core.editor()[0].contains(document.activeElement)&&(this.selection.restore(),r=!0),s=this.selection.is(),this.selection.save(),this.observe.closeAllTooltip(),n=e||!1,r&&(!1===n&&(n=this.link.is()),document.activeElement.blur()),s&&this.selection.restore(),l=this.link.buildLinkFromElement(n),s&&this.selection.save(),t.showDialog({insert:!1===n,submitCallback:function(){var t=this.link.buildLinkFromModal();return!1!==t&&(this.selection.restore(),this.link.insert(t,!0,n),this.selection.save(),window.setTimeout((()=>{document.activeElement!==this.core.editor()[0]&&this.selection.restore()}),0),!0)}.bind(this)}),l.url=this.link.removeSelfHostFromUrl(l.url),this.link.setModalValues(l),this.detect.isDesktop()&&$("#redactor-link-url").focus()}}}; })(this);
