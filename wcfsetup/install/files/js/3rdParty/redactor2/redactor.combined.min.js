...
(function (window, undefined) { $.Redactor.prototype.WoltLabObserve=function(){"use strict";return{init:function(){var t=elByClass("re-button",this.button.toolbar()[0]);this.button.setInactiveAll=function(e){for(var o,s=0,i=t.length;s<i;s++)o=t[s],o.classList.contains("re-"+e)||o.classList.remove("redactor-act")}.bind(this),this.observe.buttons=function(t,e){var o=this.selection.current();if(!1!==t?this.button.setInactiveAll():this.button.setInactiveAll(e),!1===t&&"html"!==e)return void(-1!==$.inArray(e,this.opts.activeButtons)&&this.button.toggleActive(e));if(this.utils.isRedactorParent(o)){var s=this.WoltLabSource.isActive();this.utils.isCurrentOrParentHeader()||this.utils.isCurrentOrParent(["table","pre","blockquote","li"])?this.button.disable("horizontalrule"):s||this.button.enable("horizontalrule"),this.utils.isCurrentOrParent(["table","li"])?(this.button.disable("code"),this.button.disable("spoiler"),this.button.disable("woltlabHtml"),this.button.disable("woltlabQuote")):s||(this.button.enable("code"),this.button.enable("spoiler"),this.button.enable("woltlabHtml"),this.button.enable("woltlabQuote"));var i=this.$editor[0];o.nodeType!==Node.ELEMENT_NODE&&(o=o.parentNode);for(var n,r,l=[];o!==i;)r=o.nodeName.toLowerCase(),-1===l.indexOf(r)&&(n=r,"pre"===r&&o.classList.contains("woltlabHtml")&&(n="woltlab-html"),this.opts.activeButtonsStates.hasOwnProperty(n)&&this.button.setActive(this.opts.activeButtonsStates[n]),"pre"!==r&&l.push(r)),o=o.parentNode}}.bind(this),this.observe.dropdowns=function(){var t,e=this.selection.current(),o=this.$editor[0],s=this.utils.isRedactorParent(e),i=[];if(e&&s)for(e.nodeType!==Node.ELEMENT_NODE&&(e=e.parentNode);e!==o;)t=e.nodeName.toLowerCase(),-1===i.indexOf(t)&&i.push(t),e=e.parentNode;for(var n,r=null,l=0,a=this.opts.observe.dropdowns.length;l<a;l++){n=this.opts.observe.dropdowns[l];var b=n.observe,h=b.element,u=n.item,d=!!b.in&&b.in,c=!!b.out&&b.out;"a"===h&&null===r&&(r=$("<div />").html(this.selection.html()).find("a").length),-1!==i.indexOf(h)&&s||"a"===h&&0!==r?this.observe.setDropdownProperties(u,d,c):this.observe.setDropdownProperties(u,c,d)}}.bind(this)}}}; })(this);
