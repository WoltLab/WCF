...
(function (window, undefined) { $.Redactor.prototype.WoltLabList=function(){"use strict";return{init:function(){this.list.combineAfterAndBefore=function(t){var e=$(t).prev(),i=$(t).next(),s=t&&"P"===t.tagName&&("<br>"===t.innerHTML||""===t.innerHTML),l=1===e.closest("ol, ul",this.core.editor()[0]).length&&1===i.closest("ol, ul",this.core.editor()[0]).length,o=!1;if(l&&!s&&0===t.textContent.replace(/\u200b/g,"").trim().length){var n=["A","B","BR","EM","I","STRONG","U"],r=!0;elBySelAll("*",t,function(t){-1===n.indexOf(t.nodeName)&&("SPAN"===t.nodeName&&""===t.className.trim()||(r=!1))}),r&&(o=!0,s=!0)}if(s&&l){if("LI"===t.nodeName&&o)return e.append(this.marker.get()),elRemove(t),this.selection.restore(),!0;e.children("li").last().append(this.marker.get()),e.append(i.contents());var h=t.nextElementSibling;return"OL"!==h.nodeName&&"UL"!==h.nodeName||0!==h.childElementCount||elRemove(h),o&&elRemove(t),this.selection.restore(),!0}return!1}.bind(this),this.list.toggle=function(t){if(!this.utils.inBlocks(["table","td","th","tr"])){t="orderedlist"===t?"ol":t,t="unorderedlist"===t?"ul":t,t=t.toLowerCase(),this.buffer.set(),this.selection.save();var e=this.list._getBlocks(),i=this.selection.block(),s=$(i).parent().closest("ol, ul",this.core.editor()[0]);return 0===e.length&&0!==s.length&&(e=[s.get(0)]),e=this.list._isUnformat(t,e)?this.list._unformat(t,e):this.list._format(t,e),this.selection.restore(),e}}.bind(this),this.list.toggle=function(t){if(!this.utils.inBlocks(["table","td","th","tr"])){t="orderedlist"===t?"ol":t,t="unorderedlist"===t?"ul":t,t=t.toLowerCase(),this.buffer.set(),this.selection.save();var e=this.list._getBlocks(),i=this.selection.block(),s=$(i).parent().closest("ol, ul",this.core.editor()[0]);return 0===e.length&&0!==s.length&&(e=[s.get(0)]),e=this.list._isUnformat(t,e)?this.list._unformat(t,e):this.list._format(t,e),this.selection.restore(),e}}.bind(this)}}}; })(this);
