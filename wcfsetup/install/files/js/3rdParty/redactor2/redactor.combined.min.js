...
(function (window, undefined) { $.Redactor.prototype.WoltLabLink=function(){"use strict";var t=null;return{init:function(){this.link.isUrl=function(t){var e="((xn--)?[\\W\\w\\D\\d]+(-(?!-[\\W\\w\\D\\d])+)*\\.)+[\\W\\w]{2,}",i=new RegExp("^(http|ftp|https|steam|ts3server)://"+e,"i"),s=new RegExp("^"+e,"i"),r=new RegExp(".(html|php)$","i"),l=new RegExp("^/","i"),n=new RegExp("^tel:(.*?)","i");return-1===t.search(i)&&-1!==t.search(s)&&-1===t.search(r)&&"/"!==t.substring(0,1)&&(t="https://"+t),(-1!==t.search(i)||-1!==t.search(r)||-1!==t.search(l)||-1!==t.search(n))&&t}.bind(this),this.link.show=this.WoltLabLink.show.bind(this),this.link.parse=function(t){if(this.link.isMailto(t.url))t.url="mailto:"+t.url.replace("mailto:","");else if(0!==t.url.search("#")&&this.opts.linkValidation){var e=this.link.isUrl(t.url);!1===e&&(e="https://"+t.url),t.url=e}return!this.link.isEmpty(t)&&!1!==t.url&&t}.bind(this),require(["WoltLabSuite/Core/Ui/Redactor/Link"],(function(e){t=e}))},show:function(e,i){var s,r,l;void 0!==e&&e.preventDefault&&e.preventDefault();let n=!1;this.detect.isMobile()&&!this.core.editor()[0].contains(document.activeElement)&&(this.selection.restore(),n=!0),s=this.selection.is(),this.selection.save(),this.observe.closeAllTooltip(),r=i||!1,n&&(!1===r&&(r=this.link.is()),document.activeElement.blur()),s&&this.selection.restore(),l=this.link.buildLinkFromElement(r),s&&this.selection.save(),t.showDialog({insert:!1===r,submitCallback:function(){var t=this.link.buildLinkFromModal();return!1!==t&&(this.selection.restore(),this.link.insert(t,!0,r),this.selection.save(),window.setTimeout((()=>{document.activeElement===this.core.editor()[0]&&null===this.core.editor()[0].querySelector(".redactor-selection-marker")||this.selection.restore()}),0),!0)}.bind(this)}),l.url=this.link.removeSelfHostFromUrl(l.url),this.link.setModalValues(l),this.detect.isDesktop()&&$("#redactor-link-url").focus()}}}; })(this);
