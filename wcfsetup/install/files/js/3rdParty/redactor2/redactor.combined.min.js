...
(function (window, undefined) { $.Redactor.prototype.WoltLabLink=function(){"use strict";var t=null;return{init:function(){this.link.isUrl=function(t){var i="((xn--)?[\\W\\w\\D\\d]+(-(?!-[\\W\\w\\D\\d])+)*\\.)+[\\W\\w]{2,}",e=new RegExp("^(http|ftp|https|ts3server)://"+i,"i"),s=new RegExp("^"+i,"i"),r=new RegExp(".(html|php)$","i"),n=new RegExp("^/","i"),l=new RegExp("^tel:(.*?)","i");return-1===t.search(e)&&-1!==t.search(s)&&-1===t.search(r)&&"/"!==t.substring(0,1)&&(t="http://"+t),(-1!==t.search(e)||-1!==t.search(r)||-1!==t.search(n)||-1!==t.search(l))&&t}.bind(this),this.link.show=this.WoltLabLink.show.bind(this);var i=this.link.parse;this.link.parse=function(t){var e=!1;return t.url.match(/^(https:)?\/\//)&&(e=!0),t=i.call(this,t),e&&(t.url=t.url.replace(/^http:/,"https:")),t}.bind(this),require(["WoltLabSuite/Core/Ui/Redactor/Link"],function(i){t=i})},show:function(i){void 0!==i&&i.preventDefault&&i.preventDefault();var e=this.selection.is();this.selection.save(),this.observe.closeAllTooltip();var s=this.link.is();t.showDialog({insert:!1===s,submitCallback:function(){var t=this.link.buildLinkFromModal();return!1!==t&&(this.selection.restore(),this.link.insert(t,!0),!0)}.bind(this)}),e&&this.selection.restore();var r=this.link.buildLinkFromElement(s);e&&this.selection.save(),r.url=this.link.removeSelfHostFromUrl(r.url),this.link.setModalValues(r),this.detect.isDesktop()&&$("#redactor-link-url").focus()}}}; })(this);
