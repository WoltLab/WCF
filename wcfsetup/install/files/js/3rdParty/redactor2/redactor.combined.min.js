...
(function (window, undefined) { $.Redactor.prototype.WoltLabBlock=function(){"use strict";return{preserveBlocks:["pre","woltlab-quote","woltlab-spoiler"],init:function(){this.block.tags=["p","blockquote","pre","h1","h2","h3","h4","h5","h6","div","figure"],this.block.format=function(e,t,o,i){if(e="quote"===e?"blockquote":e,-1!==$.inArray(e,this.block.tags))return"p"===e&&void 0===t&&(t="class"),this.placeholder.hide(),this.buffer.set(),this.utils.isCollapsed()?this.block.formatCollapsed(e,t,o,i):this.block.formatUncollapsed(e,t,o,i)}.bind(this);var e=function(e,t){return!(document.activeElement!==e||!1===t||!this.utils.isRedactorParent(t))}.bind(this),t=this.block.formatCollapsed;this.block.formatCollapsed=function(o,i,s,r){var l=this.selection.block();if(!l||"LI"!==l.nodeName&&"TD"!==l.nodeName){var n=this.core.editor()[0];e(n,l)||(this.selection.restore(),document.activeElement!==n&&n.focus()),e(n,l)||(this.focus.end(),this.selection.save());var a=t.call(this,o,i,s,r),h=a.length;if(1===h&&a[0].nodeName.match(/^H[1-6]$/)){var c=a[0];1===c.childElementCount&&"BR"===c.children[0].nodeName&&this.utils.isEmpty(c.innerHTML)&&(c.innerHTML="​")}else for(var d=0;d<h;d++)this.WoltLabBlock._paragraphize(a[d]);return this.caret.end(a),a}}.bind(this),this.block.formatUncollapsed=function(e,t,o,i){var s,r;this.selection.save(),this.selection.blocks().forEach(function(e){if("OL"===e.nodeName||"UL"===e.nodeName){e.parentNode.nodeName.toLowerCase();var t=elCreate("div");e.parentNode.insertBefore(t,e),t.appendChild(e)}}),this.selection.restore(),this.selection.save();var l=[],n=this.selection.blocks();n[0]&&($(n[0]).hasClass("redactor-in")||$(n[0]).hasClass("redactor-box"))&&(n=this.core.editor().find(this.opts.blockTags.join(", ")));var a=n.length;for(r=0;r<a;r++){var h=n[r].tagName.toLowerCase();if(-1!==$.inArray(h,this.block.tags)&&"figure"!==h){if("pre"!==e&&-1!==this.WoltLabBlock.preserveBlocks.indexOf(n[r].nodeName.toLowerCase())?(s=elCreate(e),n[r].parentNode.insertBefore(s,n[r]),s.appendChild(n[r]),s=$(s)):s=this.utils.replaceToTag(n[r],e),"object"==typeof t){i=o;for(var c in t)s=this.block.setAttr(s,c,t[c],i)}else s=this.block.setAttr(s,t,o,i);l.push(s),this.block.removeInlineTags(s)}}if(this.selection.restore(),"pre"===e&&0!==l.length){var d=l[0];$.each(l,function(e,t){0!==e&&($(d).append("\n"+$.trim(t.html())),$(t).remove())}),l=[],l.push(d)}var p=null;for(r=0,length=l.length;r<length;r++)if(s=l[r][0],this.WoltLabBlock._paragraphize(s),0===r)p=s;else{for(;s.childNodes.length;)p.appendChild(s.childNodes[0]);elRemove(s)}return p&&elBySelAll("br",p,function(e){e.parentNode.insertBefore(document.createTextNode("\n"),e),elRemove(e)}),$(p)}.bind(this),this.block.removeAllAttr=function(e){e=this.block.getBlocks(e);var t=[];return $.each(e,function(e,o){for(void 0===o.attributes&&t.push(o);o.attributes.length;)o.removeAttribute(o.attributes[0].name);t.push(o)}),t}.bind(this),this.block.getBlocks=function(e){if(e=void 0===e?this.selection.blocks():e,$(e).hasClass("redactor-box")||$(e).hasClass("redactor-layer")){var t=[],o=this.core.editor().children();return $.each(o,$.proxy(function(e,o){this.utils.isBlock(o)&&t.push(o)},this)),t}return e}.bind(this)},register:function(e,t){-1===this.block.tags.indexOf(e)&&(this.block.tags.push(e),this.opts.paragraphizeBlocks.push(e),-1===this.opts.blockTags.indexOf(e)&&(this.opts.blockTags.push(e),this.reIsBlock=new RegExp("^("+this.opts.blockTags.join("|").toUpperCase()+")$","i")),t&&this.WoltLabKeydown.register(e))},_paragraphize:function(e){if(-1===["p","pre","h1","h2","h3","h4","h5","h6","div","figure"].indexOf(e.nodeName.toLowerCase())){for(var t,o=!1,i=0,s=e.childNodes.length;i<s;i++){if(t=e.childNodes[i],t.nodeType===Node.TEXT_NODE){o=!0;break}if(t.nodeType===Node.ELEMENT_NODE&&-1===this.block.tags.indexOf(t.nodeName.toLowerCase())){o=!0;break}}if(o)for(var r,l=e.childNodes[0],n=null;l;)r=l.nextSibling,l.nodeType!==Node.ELEMENT_NODE||-1===this.block.tags.indexOf(l.nodeName.toLowerCase())?(null===n&&(n=elCreate("p"),e.insertBefore(n,l)),n.appendChild(l)):null!==n&&(n=null),l=r}}}}; })(this);
