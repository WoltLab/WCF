...
(function (window, undefined) { $.Redactor.prototype.WoltLabList=function(){"use strict";return{init:function(){this.list.toggle=function(t){if(!this.utils.inBlocks(["table","td","th","tr"])){var e="orderedlist"===t||"ol"===t?"OL":"UL";t="OL"===e?"orderedlist":"unorderedlist";var i=$(this.selection.current()).parentsUntil(".redactor-in","ul, ol").first();if(this.placeholder.hide(),this.buffer.set(),0!==i.length&&i[0].tagName===e&&this.utils.isRedactorParent(i))return this.selection.save(),i.find("ul, ol").each(function(){var t=$(this).closest("li");$(this).find("li").each(function(){$(t).after(this)})}),i.find("ul, ol").remove(),i.find("li").each(function(){return $(this).replaceWith(function(){return $("<p />").append($(this).contents())})}),i.replaceWith(function(){return $(this).contents()}),void this.selection.restore();this.selection.save(),0!==i.length&&i[0].tagName!==e?i.each($.proxy(function(t,i){this.utils.replaceToTag(i,e)},this)):document.execCommand("insert"+t),this.selection.restore();var n=this.list.get();if(!n)return void(this.selection.block()||document.execCommand("formatblock",!1,"p"));n.find(this.opts.inlineTags.join(",")).each(function(){"SPAN"!==this.nodeName&&$(this).removeAttr("style")});var s=n.parent();this.utils.isRedactorParent(s)&&"LI"!==s[0].tagName&&this.utils.isBlock(s)&&(this.selection.save(),s.replaceWith(s.contents()),this.selection.restore())}}.bind(this);var t=this.list.combineAfterAndBefore;this.list.combineAfterAndBefore=function(e){var i=t.call(this,e);if(i){var n=e.nextElementSibling;"OL"!==n.nodeName&&"UL"!==n.nodeName||0!==n.childElementCount||elRemove(n)}return i}.bind(this)}}}; })(this);
