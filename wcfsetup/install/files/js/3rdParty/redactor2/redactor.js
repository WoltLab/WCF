		...
		modal: function () {
			return {
				...
				templates: function () {
					this.opts.modal = {
						...
						'link': String() + '<div class="redactor-modal-tab" data-title="General">' + '<section>' + '<label>URL</label>' + '<input type="url" id="redactor-link-url" aria-label="URL" />' + '</section>' + '<section>' + '<label>' + this.lang.get(
							...
							'link-in-new-tab') + '</label>' + '</section>' + '<section>' + '<button type="button" class="button" id="redactor-modal-button-action">' + this.lang.get(
							'insert') + '</button>' + '<button type="button" class="button" id="redactor-modal-button-cancel">' + this.lang.get(
				...
				build: function () {
					...
					this.$modalClose = $(
						'<button type="button" class="button" type="button" id="redactor-modal-close" aria-label="' + this.lang.get(
						'close') + '" />').html('&times;');
