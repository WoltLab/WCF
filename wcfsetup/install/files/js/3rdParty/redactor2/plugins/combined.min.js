...
// WoltLabSmiley.js
$.Redactor.prototype.WoltLabSmiley=function(){"use strict";var t=0;return{init:function(){require(["EventHandler"],function(t){t.add("com.woltlab.wcf.redactor2","insertSmiley_"+this.$element[0].id,this.WoltLabSmiley._insert.bind(this))}.bind(this))},_insert:function(i){this.buffer.set();var e="wscSmiley_"+this.uuid+"_"+t++,n=i.img.cloneNode();n.id=e,this.insert.html(n.outerHTML),n=elById(e),n.outerHTML=n.outerHTML}}};
// WoltLabSource.js
