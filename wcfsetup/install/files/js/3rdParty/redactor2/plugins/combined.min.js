...
// WoltLabPaste.js
$.Redactor.prototype.WoltLabPaste=function(){"use strict";return{init:function(){var t=null,e=!1,i=document.documentMode&&"object"==typeof window.clipboardData,r=null,a=this.paste.init;this.paste.init=function(n){r=null;var s="pre"===this.opts.type||this.utils.isCurrentOrParent("pre");if(e=!s&&this.utils.isCurrentOrParent("kbd"),s||e){t=i?window.clipboardData.getData("Text"):n.originalEvent.clipboardData.getData("text/plain");var o=this.clean.encodeEntities;this.clean.encodeEntities=function(t){return this.clean.encodeEntities=o,WCF.String.escapeHTML(t)}.bind(this)}else if(this.detect.isFirefox()){var l=n.originalEvent.clipboardData.types;if(1===l.length&&"text/plain"===l[0]){var d=WCF.String.escapeHTML(n.originalEvent.clipboardData.getData("text/plain"));r="";var h=d.split("\n");1===h.length?r=d:h.forEach(function(t){t=t.trim(),""===t&&(t="<br>"),r+="<p>"+t+"</p>"})}}a.call(this,n)}.bind(this);var n=this.paste.getPasteBoxCode;this.paste.getPasteBoxCode=function(a){var s=n.call(this,a);return e?t:!a||s&&!i?null!==r?r:s:t}.bind(this),this.core.editor().off("paste.redactor").on("paste.redactor",this.paste.init.bind(this)),this.paste.detectClipboardUpload=function(t){t=t.originalEvent||t;var e;if(i){if(!window.clipboardData.files.length)return!1;e=window.clipboardData.files.item(0)}else{if(this.detect.isFirefox())return!1;var r=t.clipboardData,a=r.types;if(Array.isArray(a)&&-1!==a.indexOf("public.tiff"))return t.preventDefault(),!1;if(!r.items||!r.items.length)return;var n=!1;if(e=r.items[0].getAsFile(),null===e&&(this.detect.isWebkit()&&r.items.length>1&&(e=r.items[1].getAsFile(),n=!0,null!==e&&t.preventDefault()),null===e))return!1}var s=new FileReader;return s.readAsDataURL(e),s.onload=this.paste.insertFromClipboard.bind(this),n===!1}.bind(this),this.paste.insertFromClipboard=function(t){window.FormData&&(this.buffer.set(),WCF.System.Event.fireEvent("com.woltlab.wcf.redactor2","pasteFromClipboard_"+this.$element[0].id,{blob:this.utils.dataURItoBlob(t.target.result)}),this.rtePaste=!1)}.bind(this);var s="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7",o=this.paste.insert;this.paste.insert=function(t,r){if(e&&(r.pre=!0),this.utils.isCurrentOrParent("kbd")){o.call(this,t,r);var a=this.selection.current();a.nodeType===Node.TEXT_NODE&&(a=a.parentNode);for(var n=a.closest("kbd"),l=elByTag("p",n);l.length;)l[0].outerHTML=l[0].innerHTML;var d=n.innerHTML.split(/<br\s*\/?>/);if(d.length>1){for(var h=this.selection.block(),c=1,p=d.length;p>c;c++){var u=elCreate(h.nodeName);u.innerHTML="<kbd>"+d[c]+(c===p-1?this.marker.html():"")+"</kbd>",h.parentNode.insertBefore(u,h.nextSibling),h=u}n.innerHTML=d[0],this.selection.restore()}}else{if(r.pre)return o.call(this,t,r);var f=elCreate("div");f.innerHTML=t;var b=[];r.pre||r.text||elBySelAll("img",f,function(t){var e=t.src;if(0===e.indexOf("data:image")&&e!==s){t.src=s;var i=WCF.getUUID();elData(t,"uuid",i),b.push({src:e,uuid:i}),elHide(t)}}.bind(this)),o.call(this,f.innerHTML,r);var v=window.getSelection();v.rangeCount&&"A"===v.anchorNode.nodeName&&v.anchorOffset===v.anchorNode.childNodes.length&&this.caret.after(v.anchorNode),b.length&&window.setTimeout(function(){for(var t,e,r=0,a=b.length;a>r;r++)t=b[r],e=elBySel('img[data-uuid="'+t.uuid+'"]',this.$editor[0]),e&&(i?e.parentNode.removeChild(e):WCF.System.Event.fireEvent("com.woltlab.wcf.redactor2","pasteFromClipboard_"+this.$element[0].id,{blob:this.utils.dataURItoBlob(t.src),replace:e}))}.bind(this),50);var g,A=[],m=this.core.editor()[0];for(c=0,p=m.childNodes.length;p>c;c++)g=m.childNodes[c],g.nodeType===Node.TEXT_NODE&&"​"===g.textContent&&A.push(g);A.forEach(elRemove),this.rtePaste=!1}}.bind(this),this.paste.clipboardUpload=function(){}}}};
// WoltLabQuote.js
