...
// WoltLabParagraphize.js
$.Redactor.prototype.WoltLabParagraphize=function(){"use strict";return{init:function(){this.paragraphize.getSafes=function(a){var r=$("<div />").append(a);return r.find(this.opts.paragraphizeBlocks.join(", ")).each($.proxy(function(a,r){return this.paragraphize.z++,this.paragraphize.safes[this.paragraphize.z]=r.outerHTML,$(r).replaceWith("\n#####replace"+this.paragraphize.z+"#####\n\n")},this)),r.html()}.bind(this)}}};
// WoltLabQuote.js
