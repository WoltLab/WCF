...
// WoltLabBlock.js
$.Redactor.prototype.WoltLabBlock=function(){"use strict";return{init:function(){this.block.tags=["p","blockquote","pre","h1","h2","h3","h4","h5","h6","div","figure"],this.block.format=function(t,o,e,i){return t="quote"===t?"blockquote":t,-1!==$.inArray(t,this.block.tags)?("p"===t&&"undefined"==typeof o&&(o="class"),this.placeholder.hide(),this.buffer.set(),this.utils.isCollapsed()?this.block.formatCollapsed(t,o,e,i):this.block.formatUncollapsed(t,o,e,i)):void 0}.bind(this);var t=this.block.formatCollapsed;this.block.formatCollapsed=function(o,e,i,s){for(var l=t.call(this,o,e,i,s),h=0,a=l.length;a>h;h++)this.WoltLabBlock._paragraphize(l[h]);return this.caret.end(l),l}.bind(this);var o=this.block.formatUncollapsed;this.block.formatUncollapsed=function(t,e,i,s){for(var l,h=o.call(this,t,e,i,s),a=null,r=0,n=h.length;n>r;r++)if(l=h[r][0],this.WoltLabBlock._paragraphize(l),0===r)a=l;else{for(;l.childNodes.length;)a.appendChild(l.childNodes[0]);elRemove(l)}return $(a)}.bind(this)},register:function(t,o){-1===this.block.tags.indexOf(t)&&(this.block.tags.push(t),this.opts.paragraphizeBlocks.push(t),-1===this.opts.blockTags.indexOf(t)&&(this.opts.blockTags.push(t),this.reIsBlock=new RegExp("^("+this.opts.blockTags.join("|").toUpperCase()+")$","i")),o&&this.WoltLabKeydown.register(t))},_paragraphize:function(t){if(-1===["p","pre","h1","h2","h3","h4","h5","h6","div","figure"].indexOf(t.nodeName.toLowerCase())){for(var o=elCreate("p");t.childNodes.length;)o.appendChild(t.childNodes[0]);t.appendChild(o)}}}};
// WoltLabButton.js
...
// WoltLabClean.js
$.Redactor.prototype.WoltLabClean=function(){"use strict";return{init:function(){this.opts.pasteInlineTags=this.opts.pasteInlineTags.filter(function(e){return"span"!==e});var e=this.clean.onSet;this.clean.onSet=function(t){t=t.replace(/\u200B/g,""),t=t.replace(/&amp;/g,"@@@WCF_AMPERSAND@@@"),t=e.call(this,t),t=t.replace(/@@@WCF_AMPERSAND@@@/g,"&amp;");var n=elCreate("div");return n.innerHTML=t,elBySelAll("iframe",n,elRemove),t=n.innerHTML}.bind(this);var t=this.clean.onSync;this.clean.onSync=function(e){var n=elCreate("div"),r={};return e=e.replace(/&amp;/g,"@@@WCF_AMPERSAND@@@"),-1!==e.indexOf("<pre")&&(n.innerHTML=e,elBySelAll("pre",n,function(e){var t=WCF.getUUID();r[t]=e.textContent,e.textContent=t}),e=n.innerHTML),e=e.replace(/<p>\u200B<\/p>/g,"<p><br></p>"),e=t.call(this,e),e=e.replace(/@@@WCF_AMPERSAND@@@/g,"&amp;"),n.innerHTML=e,elBySelAll("span",n,function(e){e.outerHTML=e.innerHTML}),elBySelAll("pre",n,function(e){r.hasOwnProperty(e.textContent)&&(e.textContent=r[e.textContent])}),e=n.innerHTML}.bind(this);var n=this.clean.savePreFormatting;this.clean.savePreFormatting=function(e){var t=this.clean.encodeEntities;return this.clean.encodeEntities=function(e){return WCF.String.escapeHTML(e)},e=n.call(this,e),this.clean.encodeEntities=t,e}.bind(this);var r=this.clean.stripTags;this.clean.stripTags=function(e,t){return Array.isArray(t)&&t.push("span"),r.call(this,e,t)}.bind(this);var a=this.clean.onPaste;this.clean.onPaste=function(e,t,n){if(t.pre)return a.call(this,e,t,n);var r=elCreate("div");r.innerHTML=e;for(var i,l,s,o=elBySelAll("[style]",r),c=0,h=o.length;h>c;c++){i=o[c],s=[];for(var u=0,p=i.style.length;p>u;u++)l=i.style[u],this.WoltLabClean._applyInlineStyle(i,l,i.style.getPropertyValue(l))&&s.push(l);s.forEach(function(e){i.style.removeProperty(e)})}return a.call(this,r.innerHTML,t,n)}.bind(this);var i=[],l=function(e,t){for(var n={},r=0,a=t.length;a>r;r++)n[t[r]]=elAttr(e,t[r]);i.push({element:e,attributes:n})},s=this.clean.convertTags;this.clean.convertTags=function(e,t){var n=elCreate("div");return n.innerHTML=e,i=[],WCF.System.Event.fireEvent("com.woltlab.wcf.redactor2","convertTags_"+this.$element[0].id,{addToStorage:l,div:n}),i.forEach(function(e,t){e.element.outerHTML="###custom"+t+"###"+e.element.innerHTML+"###/custom"+t+"###"}),s.call(this,n.innerHTML,t)}.bind(this);var o=this.clean.reconvertTags;this.clean.reconvertTags=function(e,t){if(i.length){e=e.replace(/###(\/?)custom(\d+)###/g,'<$1woltlab-custom-tag data-index="$2">');var n=elCreate("div");n.innerHTML=e,elBySelAll("woltlab-custom-tag",n,function(e){var t=~~elData(e,"index");if(i[t]){var n=i[t],r=elCreate(n.element.nodeName);for(var a in n.attributes)n.attributes.hasOwnProperty(a)&&elAttr(r,a,n.attributes[a]);for(e.parentNode.insertBefore(r,e);e.childNodes.length;)r.appendChild(e.childNodes[0])}elRemove(e)}),e=n.innerHTML}return o.call(this,e,t)}.bind(this)},_applyInlineStyle:function(e,t,n){var r="",a="";switch(t){case"font-weight":600==n&&null===e.closest("strong")&&(a="strong")}if(a){var i=elCreate(a);return r&&(i.className=r),e.parentNode.insertBefore(i,e),i.appendChild(e),!0}return!1}}};
// WoltLabCode.js
...
// WoltLabColor.js
$.Redactor.prototype.WoltLabColor=function(){"use strict";var o=["000000","800000","8B4513","2F4F4F","008080","000080","4B0082","696969","B22222","A52A2A","DAA520","006400","40E0D0","0000CD","800080","808080","FF0000","FF8C00","FFD700","008000","00FFFF","0000FF","EE82EE","A9A9A9","FFA07A","FFA500","FFFF00","00FF00","AFEEEE","ADD8E6","DDA0DD","D3D3D3","FFF0F5","FAEBD7","FFFFE0","F0FFF0","F0FFFF","F0F8FF","E6E6FA","FFFFFF"];return{init:function(){for(var t,e=this.WoltLabColor.setColor.bind(this),r={removeColor:{title:this.lang.get("remove-color"),func:this.WoltLabColor.removeColor.bind(this)}},l=0,i=o.length;i>l;l++)t=o[l],r["color_"+t]={title:"#"+t,func:e};var s=this.button.add("woltlabColor","");this.button.addDropdown(s,r),s.data("dropdown").find("a").each(function(o,t){t.className.match(/redactor-dropdown-color_([A-F0-9]{6})/)&&(t.parentNode.classList.add("woltlab-color-"+RegExp.$1),t.parentNode.classList.add("woltlab-color-selection"))}),WCF.System.Event.addListener("com.woltlab.wcf.redactor2","convertTags_"+this.$element[0].id,function(o){elBySelAll("woltlab-color",o.div,function(t){o.addToStorage(t,["class"])})}),this.WoltLabColor.registerColors(),WCF.System.Event.addListener("com.woltlab.wcf.redactor2","codeStart_"+this.$element[0].id,this.WoltLabColor.registerColors.bind(this))},setColor:function(o){o=o.replace(/^color_/,""),this.selection.save(),require(["WoltLabSuite/Core/Ui/Redactor/Format"],function(t){this.buffer.set(),t.format(this.$editor[0],"woltlab-color","woltlab-color-"+o),this.buffer.set()}.bind(this))},removeColor:function(){this.selection.save(),require(["WoltLabSuite/Core/Ui/Redactor/Format"],function(o){this.buffer.set(),o.removeFormat(this.$editor[0],"woltlab-color"),this.buffer.set()}.bind(this))},registerColors:function(){require(["WoltLabSuite/Core/Ui/Redactor/RuntimeStyle"],function(t){elBySelAll("woltlab-color",this.$editor[0],function(e){if(e.className.match(/woltlab-color-([a-z0-9]{3}(?:[a-z0-9]{3})?)/i)){var r=RegExp.$1;3===r.length&&(r=r.substr(0,1)+r.substr(0,1)+r.substr(1,1)+r.substr(1,1)+r.substr(2,1)+r.substr(2,1)),r=r.toUpperCase(),-1===o.indexOf(r)&&t.add("woltlab-color-"+r,"color: #"+r+";")}}.bind(this))}.bind(this))}}};
...
// WoltLabPaste.js
$.Redactor.prototype.WoltLabPaste=function(){"use strict";return{init:function(){var t=null,e=document.documentMode&&"object"==typeof window.clipboardData,i=this.paste.init;this.paste.init=function(a){var r="pre"===this.opts.type||this.utils.isCurrentOrParent("pre")?!0:!1;if(r){t=e?window.clipboardData.getData("Text"):a.originalEvent.clipboardData.getData("text/plain");var s=this.clean.encodeEntities;this.clean.encodeEntities=function(t){return this.clean.encodeEntities=s,WCF.String.escapeHTML(t)}.bind(this)}i.call(this,a)}.bind(this);var a=this.paste.getPasteBoxCode;this.paste.getPasteBoxCode=function(i){var r=a.call(this,i);return!i||r&&!e?r:t}.bind(this),this.core.editor().off("paste.redactor").on("paste.redactor",this.paste.init.bind(this)),this.paste.detectClipboardUpload=function(t){t=t.originalEvent||t;var i;if(e){if(!window.clipboardData.files.length)return!1;i=window.clipboardData.files.item(0)}else{if(this.detect.isFirefox())return!1;var a=t.clipboardData,r=a.types;if(Array.isArray(r)&&-1!==r.indexOf("public.tiff"))return t.preventDefault(),!1;if(!a.items||!a.items.length)return;var s=!1;if(i=a.items[0].getAsFile(),null===i&&(this.detect.isWebkit()&&a.items.length>1&&(i=a.items[1].getAsFile(),s=!0),null===i))return!1}var n=new FileReader;return n.readAsDataURL(i),n.onload=this.paste.insertFromClipboard.bind(this),s===!1}.bind(this),this.paste.insertFromClipboard=function(t){window.FormData&&(this.buffer.set(),WCF.System.Event.fireEvent("com.woltlab.wcf.redactor2","pasteFromClipboard_"+this.$element[0].id,{blob:this.utils.dataURItoBlob(t.target.result)}),this.rtePaste=!1)}.bind(this);var r="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7",s=this.paste.insert;this.paste.insert=function(t,e){if(e.pre)return s.call(this,t,e);var i=elCreate("div");i.innerHTML=t;var a=[];e.pre||e.text||elBySelAll("img",i,function(t){var e=t.src;if(0===e.indexOf("data:image")&&e!==r){t.src=r;var i=WCF.getUUID();elData(t,"uuid",i),a.push({src:e,uuid:i}),elHide(t)}}.bind(this)),elBySelAll(".redactor-selection-marker",i,elRemove),i.appendChild(elCreate("woltlab-selection-marker")),s.call(this,i.innerHTML,e);var n=elBySel("woltlab-selection-marker",this.$editor[0]);n&&(this.caret.end(n.previousElementSibling||n.parentNode),elRemove(n)),a.length&&window.setTimeout(function(){for(var t,e,i=0,r=a.length;r>i;i++)t=a[i],e=elBySel('img[data-uuid="'+t.uuid+'"]',this.$editor[0]),e&&WCF.System.Event.fireEvent("com.woltlab.wcf.redactor2","pasteFromClipboard_"+this.$element[0].id,{blob:this.utils.dataURItoBlob(t.src),replace:e})}.bind(this),50),this.rtePaste=!1}.bind(this),this.paste.clipboardUpload=function(){}}}};
// WoltLabQuote.js
