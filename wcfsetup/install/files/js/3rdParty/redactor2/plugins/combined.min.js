...
// WoltLabPaste.js
$.Redactor.prototype.WoltLabPaste=function(){"use strict";return{init:function(){var t=null,e=this.paste.init;this.paste.init=function(i){var s="pre"===this.opts.type||this.utils.isCurrentOrParent("pre")?!0:!1;if(s){t=i.originalEvent.clipboardData.getData("text/plain");var n=this.clean.encodeEntities;this.clean.encodeEntities=function(t){return this.clean.encodeEntities=n,WCF.String.escapeHTML(t)}.bind(this)}e.call(this,i)}.bind(this);var i=this.paste.getPasteBoxCode;this.paste.getPasteBoxCode=function(e){var s=i.call(this,e);return e&&!s?t:s}.bind(this),this.core.editor().off("paste.redactor").on("paste.redactor",this.paste.init.bind(this)),this.paste.detectClipboardUpload=function(t){t=t.originalEvent||t;var e=t.clipboardData;if(this.detect.isIe()&&("edge"!==this.detect.isIe()||document.documentMode))return!0;if(this.detect.isFirefox())return!1;var i=e.types;if(Array.isArray(i)&&-1!==i.indexOf("public.tiff"))return t.preventDefault(),!1;if(e.items&&e.items.length){var s=!1,n=e.items[0].getAsFile();if(null===n&&(this.detect.isWebkit()&&e.items.length>1&&(n=e.items[1].getAsFile(),s=!0),null===n))return!1;var r=new FileReader;return r.readAsDataURL(n),r.onload=this.paste.insertFromClipboard.bind(this),s===!1}}.bind(this),this.paste.insertFromClipboard=function(t){window.FormData&&(this.buffer.set(),WCF.System.Event.fireEvent("com.woltlab.wcf.redactor2","pasteFromClipboard_"+this.$element[0].id,{blob:this.utils.dataURItoBlob(t.target.result)}))}.bind(this),this.paste.clipboardUpload=function(){elBySelAll("img",this.$editor[0],function(t){window.FormData&&0===t.src.indexOf("data:image")&&(this.buffer.set(),elHide(t),WCF.System.Event.fireEvent("com.woltlab.wcf.redactor2","pasteFromClipboard_"+this.$element[0].id,{blob:this.utils.dataURItoBlob(t.src),replace:t}))}.bind(this))}.bind(this);var s=this.paste.insert;this.paste.insert=function(t,e){if(!e.pre&&!e.text){var i=elCreate("div");i.innerHTML=t,elBySelAll("img",this.$editor[0],function(t){0===t.src.indexOf("data:image")&&elHide(t)}),t=i.innerHTML}s.call(this,t,e)}.bind(this)}}};
// WoltLabQuote.js
