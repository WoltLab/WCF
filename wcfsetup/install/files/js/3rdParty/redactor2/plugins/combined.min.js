...
// WoltLabPaste.js
$.Redactor.prototype.WoltLabPaste=function(){"use strict";return{init:function(){var t=null,e=this.paste.init;this.paste.init=function(i){var r="pre"===this.opts.type||this.utils.isCurrentOrParent("pre")?!0:!1;if(r){t=i.originalEvent.clipboardData.getData("text/plain");var s=this.clean.encodeEntities;this.clean.encodeEntities=function(t){return this.clean.encodeEntities=s,WCF.String.escapeHTML(t)}.bind(this)}e.call(this,i)}.bind(this);var i=this.paste.getPasteBoxCode;this.paste.getPasteBoxCode=function(e){var r=i.call(this,e);return e&&!r?t:r}.bind(this),this.core.editor().off("paste.redactor").on("paste.redactor",this.paste.init.bind(this)),this.paste.detectClipboardUpload=function(t){t=t.originalEvent||t;var e=t.clipboardData;if(this.detect.isIe()&&("edge"!==this.detect.isIe()||document.documentMode))return!0;if(this.detect.isFirefox())return!1;var i=e.types;if(Array.isArray(i)&&-1!==i.indexOf("public.tiff"))return t.preventDefault(),!1;if(e.items&&e.items.length){var r=e.items[0].getAsFile();if(null===r)return!1;var s=new FileReader;return s.readAsDataURL(r),s.onload=$.proxy(this.paste.insertFromClipboard,this),!0}}.bind(this),this.paste.insertFromClipboard=function(t){window.FormData&&(this.buffer.set(),WCF.System.Event.fireEvent("com.woltlab.wcf.redactor2","pasteFromClipboard_"+this.$element[0].id,{blob:this.utils.dataURItoBlob(t.target.result)}))}.bind(this),this.paste.clipboardUpload=function(){elBySelAll("img",this.$editor[0],function(t){window.FormData&&0===t.src.indexOf("data:image")&&(this.buffer.set(),elHide(t),WCF.System.Event.fireEvent("com.woltlab.wcf.redactor2","pasteFromClipboard_"+this.$element[0].id,{blob:this.utils.dataURItoBlob(t.src),replace:t}))}.bind(this))}.bind(this);var r=this.paste.insert;this.paste.insert=function(t,e){if(!e.pre&&!e.text){var i=elCreate("div");i.innerHTML=t,elBySelAll("img",this.$editor[0],function(t){0===t.src.indexOf("data:image")&&elHide(t)}),t=i.innerHTML}r.call(this,t,e)}.bind(this)}}};
// WoltLabQuote.js
