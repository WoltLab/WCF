...
$.Redactor.prototype.WoltLabMedia=function(){"use strict";return{init:function(){var t=this.button.add("woltlabMedia","");$(t).addClass("jsMediaEditorButton"),require(["WoltLab/WCF/Media/Manager/Editor"],function(t){new t({editor:this})}.bind(this))}}};// WoltLabButton.js
...
$.Redactor.prototype.WoltLabQuote=function(){"use strict";return{init:function(){var t=this.button.add("woltlabQuote","");require(["WoltLab/WCF/Ui/Redactor/Quote"],function(o){new o(this,t)}.bind(this))}}};// WoltLabEvent.js
