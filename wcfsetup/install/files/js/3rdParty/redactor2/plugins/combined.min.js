...
// WoltLabMedia.js
$.Redactor.prototype.WoltLabMedia=function(){"use strict";return{init:function(){var t=this.button.add("woltlabMedia","");$(t).addClass("jsMediaEditorButton"),require(["WoltLab/WCF/Media/Manager/Editor"],function(t){new t})}}};
// WoltLabMention.js
...
// WoltLabQuote.js
$.Redactor.prototype.WoltLabQuote=function(){"use strict";return{init:function(){var t=this.button.add("woltlabQuote","");this.button.addCallback(t,this.WoltLabQuote.insert),require(["WoltLab/WCF/Ui/Redactor/Quote"],function(t){t.initEditor(this.$element[0].id,this.$editor[0])}.bind(this))},insert:function(){require(["Dom/Traverse","WoltLab/WCF/Ui/Redactor/Quote"],function(t,i){var e=this.selection.current();e&&(e.nodeType===Node.TEXT_NODE&&(e=e.parentNode),"BLOCKQUOTE"===e.nodeName||t.parentByTag(e,"BLOCKQUOTE",this.$editor[0]))||i.insert(function(t){t.innerHTML=this.opts.invisibleSpace+this.selection.markerHtml(),this.insert.html(t.outerHTML)}.bind(this))}.bind(this))}}};
// WoltLabSize.js
