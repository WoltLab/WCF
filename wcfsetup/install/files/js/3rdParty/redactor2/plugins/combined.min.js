...
$.Redactor.prototype.WoltLabInlineCode=function(){"use strict";var e;return{init:function(){this.opts.activeButtonsStates.kbd="tt",require(["Environment","EventHandler"],function(t,n){e=t,n.add("com.woltlab.wcf.redactor2","bbcode_tt_"+this.$element[0].id,this.WoltLabInlineCode._toggle.bind(this))}.bind(this))},_toggle:function(t){t.cancel=!0,this.button.toggle({},"kbd","func","inline.format");var n=window.getSelection(),o=n.anchorNode;if(o.nodeType===Node.TEXT_NODE&&(o=o.parentNode),"KBD"===o.nodeName){var i=o.nextSibling;if("ios"===e.platform()&&"safari"===e.browser()){if(i&&"BR"===i.nodeName&&o.parentNode.insertBefore(document.createTextNode("​"),i),"​"===o.innerHTML){var r=n.getRangeAt(0);r.collapsed&&1===r.startOffset&&(o.innerHTML=this.marker.html()+"​",this.selection.restore())}return}for(;i;){if(i.nodeType!==Node.TEXT_NODE||i.textContent.length)return;i=i.nextSibling}i?(i.textContent="​",console.log("this")):(o.parentNode.appendChild(document.createTextNode("​")),console.log("this"))}}}};
// WoltLabInsert.js
