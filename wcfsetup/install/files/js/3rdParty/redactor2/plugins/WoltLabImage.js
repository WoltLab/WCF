$.Redactor.prototype.WoltLabImage = function() {
	...
	return {
		init: function() {
			...
			this.opts.modal['image-edit'] = '<div class="section">'
					...
					+ '<div class="formSubmit">'
						+ '<button type="button" id="redactor-modal-button-action" class="button buttonPrimary">Insert</button>'
						+ '<button type="button" id="redactor-modal-button-delete" class="button redactor-modal-button-offset">Delete</button>'
					+ '</div>'
				+ '</div>';
		},
		...
		add: function() {
			...
			button.addEventListener('click', this.WoltLabImage.insert);
