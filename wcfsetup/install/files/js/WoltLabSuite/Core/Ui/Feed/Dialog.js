 ...
 */
define(["require", "exports", "tslib", "../Dialog", "../../StringUtil", "WoltLabSuite/Core/Language", "../../Clipboard", "WoltLabSuite/Core/Component/Snackbar"], function (require, exports, tslib_1, Dialog_1, StringUtil, Language_1, Clipboard, Snackbar_1) {
    "use strict";
    ...
    async function copy(event) {
        ...
        (0, Snackbar_1.showSuccessSnackbar)((0, Language_1.getPhrase)("wcf.global.rss.copy.success"));
    }
    /**
    ...
    function openDialog(event) {
        ...
        if (!window.FORCE_LOGIN) {
            withoutAccessToken = `
<woltlab-core-notice type="info">${(0, Language_1.getPhrase)("wcf.global.rss.accessToken.info")}</woltlab-core-notice>
<dl>
  <dt>${(0, Language_1.getPhrase)("wcf.global.rss.withoutAccessToken")}</dt>
  <dd>
...
${withoutAccessToken}
<dl>
  <dt>${(0, Language_1.getPhrase)("wcf.global.rss.withAccessToken")}</dt>
  <dd>
    <div class="inputAddon">
...
`, {
            ...
            title: alternative.title || (0, Language_1.getPhrase)("wcf.global.button.rss"),
        });
    }
    function setup() {
