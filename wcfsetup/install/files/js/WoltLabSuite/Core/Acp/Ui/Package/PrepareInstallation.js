    ...
    class AcpUiPackagePrepareInstallation {
        ...
        submit(packageUpdateServerId) {
            ...
            if (username === "") {
                ...
                if (password === "") {
                    Util_1.default.innerError(passwordInput, (0, Language_1.getPhrase)("wcf.global.form.error.empty"));
                }
                else {
        ...
        _dialogSetup() {
            return {
                ...
                options: {
                    ...
                    title: (0, Language_1.getPhrase)("wcf.acp.package.update.unauthorized"),
                },
                source: null,
            };
        }
