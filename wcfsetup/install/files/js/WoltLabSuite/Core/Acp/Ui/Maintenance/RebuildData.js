 ...
 */
define(["require", "exports", "tslib", "../Worker", "WoltLabSuite/Core/Language"], function (require, exports, tslib_1, Worker_1, Language_1) {
    "use strict";
        ...
        return new Promise((resolve, reject) => {
            new Worker_1.default({
                ...
                callbackSuccess() {
                    ...
                    span.innerHTML = `<fa-icon name="check" solid></fa-icon> ${(0, Language_1.getPhrase)("wcf.acp.worker.success")}`;
