...
// WCF.Label.js
(function (window, undefined) { "use strict";WCF.Label={},WCF.Label.ACPList=Class.extend({_labelInput:{},_labelList:{},init:function(){},_keyPressed:function(){}}),WCF.Label.ACPList.Connect=Class.extend({init:function(){},_click:function(){}}),WCF.Label.Chooser=Class.extend({_container:null,_groups:{},_showWithoutSelection:!1,init:function(t,i,a,e){if(this._container=null,this._groups={},this._showWithoutSelection=!0===e,this._initContainers(i),$.getLength(t))for(var n in t){var o=this._groups[n];o&&WCF.Dropdown.getDropdownMenu(o.wcfIdentify()).find("> ul > li:not(.dropdownDivider)").each($.proxy(function(i,a){var e=$(a),o=e.data("labelID")||0;o&&t[n]==o&&this._selectLabel(e,!0)},this))}for(var l in this._containers){var s=this._containers[l];void 0===s.data("labelID")&&s.data("labelID",0)}this._container=$(i),a?$(a).click($.proxy(this._submit,this)):this._container.is("form")&&this._container.submit($.proxy(this._submit,this))},_initContainers:function(t){$(t).find(".labelChooser").each($.proxy(function(t,i){var a=$(i),e=a.data("groupID");if(!this._groups[e]){var n=a.wcfIdentify(),o=WCF.Dropdown.getDropdownMenu(n);null===o&&(WCF.Dropdown.initDropdown(a.find(".dropdownToggle")),o=WCF.Dropdown.getDropdownMenu(n));var l=o;if("div"==o.getTagName()&&o.children(".scrollableDropdownMenu").length&&(l=$("<ul />").appendTo(o),o=o.children(".scrollableDropdownMenu")),this._groups[e]=a,o.children("li").data("groupID",e).click($.proxy(this._click,this)),a.data("forceSelection")&&!this._showWithoutSelection||$('<li class="dropdownDivider" />').appendTo(l),this._showWithoutSelection&&$('<li data-label-id="-1"><span><span class="badge label">'+WCF.Language.get("wcf.label.withoutSelection")+"</span></span></li>").data("groupID",e).appendTo(l).click($.proxy(this._click,this)),!a.data("forceSelection")){$('<li data-label-id="0"><span><span class="badge label">'+WCF.Language.get("wcf.label.none")+"</span></span></li>").data("groupID",e).appendTo(l).click($.proxy(this._click,this))}}},this))},_click:function(t){this._selectLabel($(t.currentTarget),!1)},_selectLabel:function(t,i){var a=this._groups[t.data("groupID")];i&&void 0!==a.data("labelID")||(t.data("labelID")?a.data("labelID",t.data("labelID")):a.data("labelID",0),t=t.find("span > span"),a.find(".dropdownToggle > span").removeClass().addClass(t.attr("class")).text(t.text()))},_submit:function(){var t=this._container.find(".formSubmit");t.find('input[type="hidden"]').each(function(t,i){var a=$(i);0===a.attr("name").indexOf("labelIDs[")&&a.remove()});for(var i in this._groups){var a=this._groups[i];a.data("labelID")&&$('<input type="hidden" name="labelIDs['+i+']" value="'+a.data("labelID")+'" />').appendTo(t)}}}),WCF.Label.ArticleLabelChooser=WCF.Label.Chooser.extend({_labelGroupsToCategories:{},init:function(){},_updateLabelGroups:function(){},_submit:function(){}}); })(this);
