...
const Manager = {
   ...
   */
  addContainerCheckCallback(callback: Callback): void {
   ...
   */
  addDependency(dependency: FormBuilderFormFieldDependency): void {
   ...
   */
  isHiddenByDependencies(node: HTMLElement): boolean {
