 ...
 * @property-read   0|1     $isBlockElement is `1` if the bbcode represents a block element and thus can contain multiple lines, otherwise `0`
 ...
 * @property-read   0|1     $isSourceCode   is `1` if the bbcode's content is treated as source code, otherwise `0`
 * @property-read   0|1     $showButton     is `1` if a button for the bbcode will be shown in the editor toolbar, otherwise `0`
 * @property-read   0|1     $originIsSystem is `1` if the bbcode has been delivered by a package, otherwise `0` (if the bbcode has been created by an admin in the acp)
 */
