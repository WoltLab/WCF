 ...
 * @property-read   ?int    $parentItemID   id of the menu item's parent menu item or null if it has no parent menu item
 ...
 * @property-read   ?int    $pageID         id of the linked `wcf\data\page\Page` object or null of no such page is linked
 ...
 * @property-read   0|1     $isDisabled     is `1` if the menu item is disabled and thus not shown in the menu, otherwise `0`
 * @property-read   0|1     $originIsSystem is `1` if the menu item has been delivered by a package, otherwise `0` (if the menu item has been created by an admin in the ACP)
