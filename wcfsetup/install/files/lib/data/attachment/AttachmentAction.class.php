...
class AttachmentAction extends AbstractDatabaseObjectAction implements ISortableAction, IUploadAction
{
    ...
    public function validateUpload()
    {
        ...
        if (isset($_POST['isFallback'])) {
            $this->parameters['objectType'] = $_POST['objectType'] ?? '';
            $this->parameters['objectID'] = $_POST['objectID'] ?? 0;
            $this->parameters['parentObjectID'] = $_POST['parentObjectID'] ?? 0;
            $this->parameters['tmpHash'] = $_POST['tmpHash'] ?? '';
        }
