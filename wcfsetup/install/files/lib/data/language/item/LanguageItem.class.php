 ...
 * @property-read   0|1     $languageUseCustomValue     is `1` if the custom value is used instead of the default value, otherwise `0`
 * @property-read   0|1     $languageItemOriginIsSystem is `1` if the language item has been delivered by a package, otherwise `0` (for example, if language item has been created for i18n content)
 * @property-read   int     $languageCategoryID         id of the language category the language item belongs to
 * @property-read   int     $packageID                  id of the package the which delivers the language item or with which the language item is associated
 ...
 * @property-read   0|1     $isCustomLanguageItem       is `1` if the language item has been added manually via the ACP
 */
