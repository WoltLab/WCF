 ...
 * @property-read   0|1     $isTainted          is `0` if the original declarations of an imported or installed style are not and cannot be altered, otherwise `1`
 * @property-read   0|1     $hasFavicon         is `0` if the default favicon data should be used
