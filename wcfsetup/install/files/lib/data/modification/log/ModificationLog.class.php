 ...
 * @property-read   ?int    $parentObjectID     id of the object's parent object to which the modification log entry belongs to or `null` if no such parent object exists or is logged
 * @property-read   ?int    $userID             id of the user who caused the modification log entry or `null` if the user does not exist anymore or if the modification log entry has been caused by a guest
