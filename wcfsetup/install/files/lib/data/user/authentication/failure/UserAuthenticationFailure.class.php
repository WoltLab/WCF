 ...
 * @property-read   ?int    $userID             id of the user using an incorrect password or null if the provided username or email address is not associated with any registered user
