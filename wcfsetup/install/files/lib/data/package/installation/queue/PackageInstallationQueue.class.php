 ...
 * @property-read   0|1     $done           is `1` if the package installation queue entry has been completed, otherwise `0`
 * @property-read   0|1     $isApplication  is `1` if the package installation queue entry belongs to an application, otherwise `0`
 */
