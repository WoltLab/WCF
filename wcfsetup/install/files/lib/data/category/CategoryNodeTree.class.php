...
class CategoryNodeTree implements \IteratorAggregate {
	 ...
	 */
	protected function buildTreeLevel($parentNode) {
		foreach (CategoryHandler::getInstance()->getChildCategories($parentNode->categoryID, $parentNode->objectTypeID) as $childCategory) {
