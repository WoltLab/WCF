...
class LikeableComment extends AbstractLikeObject implements IReactionObject
{
    ...
    public function sendNotification(Like $like)
    {
        ...
        if (UserNotificationHandler::getInstance()->getObjectTypeID($objectType->objectType . '.like.notification') !== 0 && UserNotificationHandler::getInstance()->getObjectTypeProcessor($objectType->objectType . '.like.notification')->supportsReactions === '1') {
