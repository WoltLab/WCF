 ...
 * @property-read   ?int    $userID             id of the user who has created the previous version of the object or `null` if the user does not exist anymore or if the previous version has been created by a guest
 ...
 * @property-read   ?int    $obsoletedByUserID  id of the user who has created this version of the object
