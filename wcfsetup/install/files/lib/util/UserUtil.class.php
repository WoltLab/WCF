...
final class UserUtil {
	...
	public static function usesMobileBrowser() {
		return self::isMobileBrowser(self::getUserAgent());
	}
	 ...
	 * @since       5.4
	 */
	public static function isMobileBrowser(string $userAgent): bool {
	...
	public static function getBrowser(string $userAgent): string {
		$parameters = ['browser' => '', 'userAgent' => $userAgent];
		EventHandler::getInstance()->fireAction(self::class, 'getBrowser', $parameters);
