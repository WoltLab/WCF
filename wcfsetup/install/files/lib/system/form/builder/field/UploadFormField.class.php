...
class UploadFormField extends AbstractFormField
{
    ...
    public function updatedObject(array $data, IStorableObject $object, $loadValues = true)
    {
        if ($loadValues) {
            ...
            // first check, whether a getter for the field exists; preferring get{$fieldName}UploadFiles() before get{$fieldName}UploadFileLocations() and get{$fieldName}()
            if (\method_exists($object, "get{$propertyName}UploadFiles")) {
                try {
                    ...
                    throw new \InvalidArgumentException("The method {$className}::get{$propertyName}UploadFiles() must return an array of objects of class '" . UploadFile::class . "' with the valid file locations for field '{$this->getId()}'.", 0, $e);
                }
                ...
                try {
                    ...
                    throw new \InvalidArgumentException("The method {$className}::get{$propertyName}UploadFileLocations() must return an array of strings with the valid file locations for field '{$this->getId()}'.", 0, $e);
                }
                ...
                try {
                    ...
                    throw new \InvalidArgumentException("The method {$className}::get{$propertyName}() must return an array of objects of strings with the valid file locations for field '{$this->getId()}'.", 0, $e);
                }
            } else {
                ...
                try {
                    ...
                    throw new \InvalidArgumentException("The property {$className}::\${$variableName} must contain an array of strings with the valid file locations for field '{$this->getId()}'.", 0, $e);
                }
            }
