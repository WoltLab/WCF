...
interface IFormFieldValidationError
{
     ...
     * @param ?string $languageItem language item containing the error message
     * @param array<string, mixed> $information additional error information, also used to resolve error message from language item
     *
     ...
     *
     * @return array<string, mixed> additional error information
     */
