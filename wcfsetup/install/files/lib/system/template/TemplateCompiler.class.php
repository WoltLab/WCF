...
class TemplateCompiler extends TemplateScriptingCompiler
{
     ...
     * @return void
     */
    public function compile(string $templateName, string $sourceContent, string $compiledFilename, array $metaData)
    {
        $writer = new AtomicWriter($compiledFilename);
        // build fileheader for template
        $writer->write("<?php\n/**\n * WoltLab Suite\n * Template: " . $templateName . "\n * Compiled at: " . \gmdate('r') . "\n * \n * DO NOT EDIT THIS FILE\n */\n\$this->v['tpl']['template'] = '" . \addcslashes(
            $templateName,
            "'\\"
        ) . "';\n?>\n");
     ...
     * @return void
     */
    public function saveMetaData(string $templateName, string $filename, array $content)
    {
