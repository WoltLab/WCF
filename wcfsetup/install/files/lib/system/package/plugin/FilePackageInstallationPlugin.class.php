...
class FilePackageInstallationPlugin extends AbstractPackageInstallationPlugin {
	...
	public function install() {
		...
		if ($this->installation->getPackage()->isApplication == 1 && $this->installation->getPackage()->package != 'com.woltlab.wcf' 
			&& $this->installation->getAction() == 'install' && $abbreviation != 'wcf') {
			// touch file
