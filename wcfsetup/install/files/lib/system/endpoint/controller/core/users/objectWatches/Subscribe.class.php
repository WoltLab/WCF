 ...
 * @since       6.3
 */
#[PostRequest('/core/users/object-watches/subscribe')]
final class Subscribe implements IController
{
    #[\Override]
    public function __invoke(ServerRequestInterface $request, array $variables): ResponseInterface
    {
        $parameters = Helper::mapApiParameters($request, SubscribeParameters::class);
        ...
        new \wcf\command\user\object\watch\Subscribe(
            $objectType,
            $parameters->objectID,
            WCF::getUser(),
            $parameters->enableNotification,
        )();
...
/** @internal */
final class SubscribeParameters
{
    public function __construct(
        ...
        public readonly bool $enableNotification = false,
    ) {}
}
