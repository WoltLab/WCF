...
/**
 * Enables the sitemap object with the given name.
 *
 * @author      Marcel Werk
 ...
 * @since       6.3
 */
#[PostRequest('/core/sitemaps/{id}/enable')]
final class EnableSitemapObject implements IController
{
    #[\Override]
    public function __invoke(ServerRequestInterface $request, array $variables): ResponseInterface
    {
        ...
        SitemapHandler::getInstance()->setIsDisabled($sitemapObject, false);
