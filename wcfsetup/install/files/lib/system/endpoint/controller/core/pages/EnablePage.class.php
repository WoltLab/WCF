...
/**
 * Enables the page with the given ID.
 *
 * @author      Olaf Braun
 ...
 * @since       6.2
 */
#[PostRequest('/core/pages/{id:\d+}/enable')]
final class EnablePage implements IController
{
    #[\Override]
    ...
    private function assertPageCanBeEnabled(Page $page): void
    {
