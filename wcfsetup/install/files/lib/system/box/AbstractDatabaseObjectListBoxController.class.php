...
abstract class AbstractDatabaseObjectListBoxController extends AbstractBoxController implements IConditionBoxController
{
     ...
     * @since 5.2
     */
    public function addPipGuiFormFields(IFormDocument $form, string $objectType)
    {
     ...
     * @since 5.2
     */
    public function getPipGuiElementData(\DOMElement $element, bool $saveData = false)
    {
        $data = [];
     ...
     */
    #[\Override]
    public function setBox(Box $box, bool $setConditionData = true)
    {
        parent::setBox($box);
    ...
    public function validateConditions()
    {
        if ($this->defaultLimit !== null) {
            ...
            } elseif ($this->maximumLimit !== null && $this->limit > $this->maximumLimit) {
