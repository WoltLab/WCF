            ...
            if (!empty($values)) {
                ...
                if ($package !== null) {
                    ...
                    if (isset($values['title'])) {
                        $updateData['title'] = 'wcf.category.category.title.category' . $category->categoryID;
                    }
                    if (isset($values['description'])) {
                        $updateData['description'] = 'wcf.category.category.description.category' . $category->categoryID;
                    }
