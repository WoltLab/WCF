 ...
 */
final class UserEmailConditionType extends AbstractConditionType implements IDatabaseObjectListConditionType, IObjectConditionType
{
    #[\Override]
    ...
    {
        return 'wcf.condition.user.email';
    }
    ...
    public function applyFilter(DatabaseObjectList $objectList): void
    {
        ...
        $objectList->getConditionBuilder()->add(
            $objectList->getDatabaseTableAlias() . '.email LIKE ?',
            [$filter]
        );
    }
    ...
    public function matches(object $object): bool
    {
        ...
        return match ($condition) {
            "_%" => \str_starts_with($object->email, $value),
            "%_%" => \str_contains($object->email, $value),
            "%_" => \str_ends_with($object->email, $value),
            default => false,
        };
    }
