...
class StyleGlobalValuesForm extends AbstractForm
{
    ...
    public function readData()
    {
        ...
        if (empty($_POST)) {
            $this->styles = (string)RegistryHandler::getInstance()->get('com.woltlab.wcf',
    ...
    public function validate()
    {
        ...
        try {
            ...
            if ($defaultStyle !== null) {
                ...
                $errorMessage = StyleCompiler::getInstance()->testStyle($this->styleTestFileDir,
                    $defaultStyle->styleName, $defaultStyle->apiVersion, $defaultStyle->imagePath,
                    $defaultStyle->getVariables(), $tmpFile);
    ...
    public function save()
    {
        ...
        if (empty($this->styles)) {
            ...
            RegistryHandler::getInstance()->set('com.woltlab.wcf', StyleCompiler::REGISTRY_GLOBAL_VALUES,
                $this->styles);

            \file_put_contents(WCF_DIR . StyleCompiler::FILE_GLOBAL_VALUES,
                "/*\n\n  DO NOT EDIT THIS FILE!\n\n  dynamic global SCSS values, generated at " . \date('r',
                    TIME_NOW) . "\n\n*/\n\n" . $this->styles);
        }
