...
class StyleExportForm extends AbstractForm
{
    ...
    public function readParameters()
    {
        ...
        if ($this->style->templateGroupID !== null) {
    ...
    public function readFormParameters()
    {
        ...
        if ($this->canExportTemplates && isset($_POST['exportTemplates'])) {
            $this->exportTemplates = true;
        }
    ...
    public function save()
    {
        ...
        // get style filename
        $filename = \str_replace(' ', '-', \preg_replace(
            '/[^a-z0-9 _-]/',
            '',
            \mb_strtolower($this->style->styleName)
        ));
