...
ALTER TABLE wcf1_comment_response ADD COLUMN isDisabled TINYINT(1) NOT NULL DEFAULT '0', ADD COLUMN enableHtml TINYINT(1) NOT NULL DEFAULT 0;
...
ALTER TABLE wcf1_style ADD COLUMN hasFavicon TINYINT(1) NOT NULL DEFAULT 0, ADD COLUMN apiVersion ENUM('3.0', '3.1') NOT NULL DEFAULT '3.0', ADD COLUMN image2x VARCHAR(255) NOT NULL DEFAULT '';
