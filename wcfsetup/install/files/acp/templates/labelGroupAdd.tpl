...
<header class="contentHeader">
	...
	<nav class="contentHeaderNavigation">
		<ul>
			{if $action == 'edit'}
				<li><a href="{link controller='LabelList' id=$groupID}{/link}" class="button">{icon size=16 name='list'} <span>{lang}wcf.acp.label.list{/lang}</span></a></li>
			{/if}
			<li><a href="{link controller='LabelGroupList'}{/link}" class="button">{icon size=16 name='list'} <span>{lang}wcf.acp.label.group.list{/lang}</span></a></li>
