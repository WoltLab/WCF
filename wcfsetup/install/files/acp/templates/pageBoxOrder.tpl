...
<header class="contentHeader">
	...
	<nav class="contentHeaderNavigation">
		<ul>
			{if $hasCustomShowOrder}<li><a href="#" class="button jsButtonCustomShowOrder">{icon name='xmark'} <span>{lang}wcf.acp.page.boxOrder.discard{/lang}</span></a></li>{/if}
			<li><a href="{link controller='PageEdit' id=$page->pageID}{/link}" class="button">{icon name='pencil'} <span>{lang}wcf.acp.page.edit{/lang}</span></a></li>
