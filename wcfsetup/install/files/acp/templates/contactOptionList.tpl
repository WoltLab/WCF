...
<header class="contentHeader">
	<div class="contentHeaderTitle">
		<h1 class="contentTitle">{lang}wcf.acp.contact.options{/lang}</h1>
	</div>
	...
	<nav class="contentHeaderNavigation">
		<ul>
			...
			{/if}
			<li><a href="{link controller='ContactOptionAdd'}{/link}" class="button buttonPrimary">{icon name='plus'} <span>{lang}wcf.acp.contact.option.add{/lang}</span></a></li>
