				...
				{content}
					{if $diff !== null}
						{if $parent->templateGroupID}
							<li><a href="{link controller='TemplateEdit' id=$parent->templateID}{/link}" class="button">{icon size=16 name='pencil' type='solid'} <span>{lang}wcf.global.button.edit{/lang}</span></a></li>
						{/if}
					{/if}
				...
				*}</pre>
				...
				<footer class="contentFooter">
					<nav class="contentFooterNavigation">
						<ul>
							<li><a href="{link controller='TemplateEdit' id=$template->templateID}{/link}" class="button">{icon size=16 name='pencil' type='solid'} <span>{lang}wcf.global.button.edit{/lang}</span></a></li>
