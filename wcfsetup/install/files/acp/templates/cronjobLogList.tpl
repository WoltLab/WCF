	...
	{hascontent}
		<nav class="contentHeaderNavigation">
			<ul>
				{content}
					{if $objects|count}
						<li><a title="{lang}wcf.acp.cronjob.log.clear{/lang}" class="button jsCronjobLogDelete">{icon size=16 name='xmark'} <span>{lang}wcf.acp.cronjob.log.clear{/lang}</span></a></li>
					{/if}
