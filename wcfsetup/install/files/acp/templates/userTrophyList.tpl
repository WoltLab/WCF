	...
	<div class="section tabularBox">
		...
		<table class="table jsObjectActionContainer" data-object-action-class-name="wcf\data\user\trophy\UserTrophyAction">
			...
			<tr>
				...
				<th class="columnText columnUsername{if $sortField == 'users.username'} active {@$sortOrder}{/if}"><a href="{link controller='UserTrophyList'}pageNo={@$pageNo}&sortField=users.username&sortOrder={if $sortField == 'users.username' && $sortOrder == 'ASC'}DESC{else}ASC{/if}{@$linkParameters}{/link}">{lang}wcf.user.username{/lang}</a></th>
