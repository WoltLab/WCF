...
<div class="layout-boundary">
	<header>
		...
		<ul class="language-switcher">
			<li><a href="./test.php?language=de"
			       class="language<?= ($language === 'de' ? ' active' : '') ?>">Deutsch</a></li>
			<li><a href="./test.php?language=en"
			       class="language<?= ($language === 'en' ? ' active' : '') ?>">English</a></li>
		</ul>
	</header>
	...
	<main>
		...
		<h2><?= getPhrase('result') ?></h2>
		    ...
		    <p style="margin-top: 50px; text-align: center;"><a href="install.php"
		                                                        class="button"><?= getPhrase('button_start_installation') ?></a>
		    </p>
            <?php } ?>
	</main>
	<footer>
