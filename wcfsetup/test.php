...
$phrases = [
	...
	'mysql_version' => [
		'de' => 'Bitte stellen Sie sicher, dass MySQL 5.5.35+/MySQL 8.0.14+  oder MariaDB 10.1.44+ mit InnoDB-Unterstützung vorhanden ist.',
		'en' => 'Please make sure that MySQL 5.5.35+/MySQL 8.0.14+ or MariaDB 10.1.44+, with InnoDB support is available.'
	],
	'result' => [
		'de' => 'Ergebnis',
		'en' => 'Summary'
